...
use \DotPlant\Reviews\behaviors\CustomReviewsBehavior;
use \DotPlant\Reviews\handlers\CustomReviewsHandler;

class Module extends ExtensionModule implements BootstrapInterface
{

    public static $moduleId = 'Reviews';
        ...
        $app->on(
            ...
            function () use ($app) {
                ...
                Event::on(
                    ...
                    [CustomReviewsBehavior::className(), 'handleInit']
                );
                /**
                ...
                Event::on(
                    ...
                    [CustomReviewsHandler::className(), 'saveReviewProperties']
                );
    ...
    public function renderEditForm(BackendEntityEditFormEvent $event)
    {
        ...
        echo $view->render('@Reviews/views/edit', $params);
    }
